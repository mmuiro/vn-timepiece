...
export default function Navbar() {
    ...
    return(<>
    <nav className="bg-gradient-to-br from from-rose-500 to-pink-500 drop-shadow-sm border-b-2 border-pink-600">
        <div className="max-w-7xl mx-auto">
            <div className="h-14 px-10 flex items-center justify-between">
                ...
                <div className="flex items-center justify-center">
                    <Searchbar />
                    {authState.signedIn && <><Link to="/settings">
                        <svg xmlns="http://www.w3.org/2000/svg" className="transition h-6 w-6 fill-pink-700 ml-6 mr-4 hover:fill-primary-light" viewBox="0 0 20 20">
