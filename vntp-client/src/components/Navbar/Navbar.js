...
export default function Navbar() {
    return(<>
    <nav className="bg-primary drop-shadow-sm border-b-2 border-primary-dark">
            ...
            <div className="h-14 px-10 flex items-center justify-between">
                <div className="flex items-center justify-between">
                    <Link className="flex items-center flex-shrink-0 mr-16" to="/">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 stroke-2 stroke-white fill-transparent" viewBox="0 0 24 24"> {/* logo placeholder */}
                ...
                <div className="flex items-center justify-center">
                    ...
                    <Link to="/logout">
                        <svg xmlns="http://www.w3.org/2000/svg" className="transition h-6 w-6 stroke-primary-dark fill-transparent hover:stroke-primary-light" viewBox="0 0 24 24">
